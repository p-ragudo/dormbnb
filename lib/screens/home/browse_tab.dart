...
class _BrowseScreenState extends State<BrowseScreen> {
  ...
  final List<DormModel> sampleDorms = [
    DormModel(
      ...
      distanceToMseuf: '3 mins walk',
      genderPolicy: DormModel.femaleOnly,
    ...
    DormModel(
      ...
      distanceToMseuf: '5 mins walk',
      genderPolicy: DormModel.maleOnly,
    ...
    DormModel(
      ...
      address: 'Sitio Lorenzo, Brgy Ibabang Dupay, Lucena City',
      distanceToMseuf: '2 mins walk',
      genderPolicy: DormModel.maleFemale,
    ...
    setState(() {
      _filteredDorms = sampleDorms.where((dorm) {
        ...
        if (_selectedCategoryFilter != "All") {
          // Updated from 'tags' to 'amenities'
